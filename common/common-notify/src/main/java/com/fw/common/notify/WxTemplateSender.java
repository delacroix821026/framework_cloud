package net.pingzhuo.pzmall.core.notify;
...
import net.pingzhuo.pzmall.db.domain.PzmallUserFormid;
import net.pingzhuo.pzmall.db.service.PzmallUserFormIdService;
...
public class WxTemplateSender {
    ...
    @Autowired
    private PzmallUserFormIdService formIdService;
    ...
    private void sendMsg(String touser, String templatId, String[] parms, String page, String color,
        ...
        PzmallUserFormid userFormid = formIdService.queryByOpenId(touser);
        if (userFormid == null)
            return;
