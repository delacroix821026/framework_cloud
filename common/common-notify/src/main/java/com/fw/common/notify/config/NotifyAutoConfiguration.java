package net.pingzhuo.pzmall.core.notify.config;

import com.github.qcloudsms.SmsSingleSender;
import net.pingzhuo.pzmall.core.notify.NotifyService;
import net.pingzhuo.pzmall.core.notify.TencentSmsSender;
import net.pingzhuo.pzmall.core.notify.WxTemplateSender;
